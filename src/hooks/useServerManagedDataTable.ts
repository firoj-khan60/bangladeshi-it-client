...
export const useServerManagedDataTable = ({
  ...
  const [prevSortingStateFromUrl, setPrevSortingStateFromUrl] =
    useState<SortingState>(sortingStateFromUrl);
  const [prevPaginationStateFromUrl, setPrevPaginationStateFromUrl] =
    useState<PaginationState>(paginationStateFromUrl);

  if (sortingStateFromUrl !== prevSortingStateFromUrl) {
    setPrevSortingStateFromUrl(sortingStateFromUrl);
    setOptimisticSortingState(sortingStateFromUrl);
  }

  if (paginationStateFromUrl !== prevPaginationStateFromUrl) {
    setPrevPaginationStateFromUrl(paginationStateFromUrl);
