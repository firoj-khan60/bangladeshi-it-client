...
export default function DashboardError({
  ...
  return (
    <div className="h-[80vh] flex flex-col items-center justify-center p-8 text-center animate-in zoom-in-95 duration-300">
      <div className="h-20 w-20 bg-amber-500/10 rounded-3xl flex items-center justify-center mb-6 border border-amber-500/20">
        <AlertTriangle className="h-10 w-10 text-amber-500" />
      </div>
      
      <h2 className="text-2xl font-black text-foreground mb-2">Dashboard Error</h2>
      ...
      <div className="flex gap-4">
        <Button
          onClick={() => reset()}
          className="h-12 px-8 rounded-xl bg-foreground text-background font-bold uppercase tracking-widest hover:bg-primary transition-all flex items-center gap-2"
        >
      ...
      <div className="mt-12 p-4 rounded-2xl bg-muted border border-border">
